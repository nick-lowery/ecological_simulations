function LV_competition_function(L,N,D,P,pillarq,R,dx_mult,rep)
...
%                 '_dsc-' num2str(dsc) '_' num2str(q) '.png']))
            ...
            image_save(im_out,fullfile(path1,[file1 '_' num2str(q) '.png']))
        end
    end
end
...
save([file1 '_metadata.mat'], 'L', 'N', 'D', 'P', 'pillarq', 'R', 'dx', 'dt', 'dsc', 'meanA_out', 'meanB_out', 'meanC_out', 'scale_fac', 'rep')
