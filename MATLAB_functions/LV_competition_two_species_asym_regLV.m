...
% 
% This function runs a non-dimensionalized competitive 2D Lotka-Volterra ecological
% simulation (note difference from other simulation files; this script runs 
% the 'classic' version of the LV model with a single competition parameter,
% alpha) of two mutally killing species, and outputs images of the simulation 
